                    ...
                    <div class="card-header">ADD MENU</div>
                        <div class="card-body">
                            <form action="../../controller/menuController.php" method="post">       
                                ...
                                <input class="form-check-input" type="radio" name="make_table" id="make_table1" value="yes" onclick="toggleColumnInput(true)">
                                <label class="form-check-label" for="make_table1">
                                    Ya
                                </label>
                                </div>
                                <div class="form-check">
                                <input class="form-check-input" type="radio" name="make_table" id="make_table2" value="no" onclick="toggleColumnInput(false)">
                        ...
                        <div class="card-body">
                            <form action="../../controller/menuController.php" method="post">       
                                <input type="hidden" name="menuIdEdt" value="<?=htmlspecialchars((base64_decode($_GET['ed'])))?>">
                                <?php ?>
                            <div class="form-group">
                                    <label for="id_level">Jurusan</label>
                                    <select name="id_level" id="id_level" class="form-control" required>
                                ...
                                <div class="form-group">
                                    <label for="nama_menu">Nama Menu</label>
                                    <input type="text" name="nama_menu" id="nama_menu" class="form-control" value="<?=(isset($menuEdt['nama_menu'])) ? $menuEdt['nama_menu'] : 'Belum Ada Nama Menu'?>">
                                </div>
                                <div class="form-group">
                                    <label for="url">Nama URL</label>
                                    <input type="text" name="url" id="url" class="form-control" value="<?=(isset($menuEdt['url'])) ? $menuEdt['url'] : 'Belum Ada URL'?>">
                                </div>
                                <div class="form-group">
                                    <label for="icon">Icons</label>
                                    <select name="icon" id="icon" class="form-control">
                                        <option value="">--Pilih Icons--</option>
                                        <option value="fas fa-fw fa-tachometer-alt" <?= (isset($menuEdt['icon']) && $menuEdt['icon'] === 'fas fa-fw fa-tachometer-alt') ? 'selected' : '' ?>>Tachometer <i class="fas fa-fw fa-tachometer-alt"></i></option>
                                        <option value="fas fa-fw fa-cog" <?= (isset($menuEdt['icon']) && $menuEdt['icon'] === 'fas fa-fw fa-cog') ? 'selected' : '' ?>>Cog <i class="fas fa-fw fa-cog"></i></option>
                                        <option value="fas fa-fw fa-wrench" <?= (isset($menuEdt['icon']) && $menuEdt['icon'] === 'fas fa-fw fa-wrench') ? 'selected' : '' ?>>Wrench <i class="fas fa-fw fa-wrench"></i></option>
                                        <option value="fas fa-fw fa-folder" <?= (isset($menuEdt['icon']) && $menuEdt['icon'] === 'fas fa-fw fa-folder') ? 'selected' : '' ?>>Folder <i class="fas fa-fw fa-folder"></i></option>
                                        <option value="fas fa-fw fa-chart-area" <?= (isset($menuEdt['icon']) && $menuEdt['icon'] === 'fas fa-fw fa-chart-area') ? 'selected' : '' ?>>Chart Area <i class="fas fa-fw fa-chart-area"></i></option>
                                        <option value="fas fa-fw fa-table" <?= (isset($menuEdt['icon']) && $menuEdt['icon'] === 'fas fa-fw fa-table') ? 'selected' : '' ?>>Table <i class="fas fa-fw fa-table"></i></option>
                                    </select>
                                </div>
                                ...
                                <label for="table">Apakah ingin buat Table ?</label>
                                <div class="form-check">
                                <input class="form-check-input" type="radio" name="make_table" id="make_table1" value="yes" onclick="toggleColumnInput(true)" required>
                                <label class="form-check-label" for="make_table1">
                                    Ya
                                </label>
                                </div>
                                <div class="form-check">
                                <input class="form-check-input" type="radio" name="make_table" id="make_table2" value="no" onclick="toggleColumnInput(false)" required>
                                <label class="form-check-label" for="make_table2">
                                    Tidak
                                </label>
                                </div>
                                ...
                                <div class="form-group" id="columnInput" style="display: none;">
                                    <label for="num_columns">Isi Jumlah Kolom:</label>
                                    <input class="form-control" type="number" name="num_columns" id="num_columns" min="0" value="<?=(isset($menuEdt['num_columns'])) ? $menuEdt['num_columns'] : 'Belum Ada URL'?>" required>
                                    <br><br>
                                </div>
                                <!-- Container untuk input kolom dinamis -->
                                <div id="columnInputsContainer" class="mb-3"></div>
                         ...
                         <?php 
                                    ...
                                    foreach ($menus as $key => $menu) {
                                        ...
                                        if (isset($page) && $page === $page_url) {
                                            ...
                                            <?php
                                            // Hentikan loop setelah menemukan halaman yang cocok
                                            break;
                                        }
                                    }
                                }
